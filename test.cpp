...
TEST_F(CollectionTest, CapacitySizeTest) {
    add_entries(11);
...
TEST_F(CollectionTest, ResizeTest) {
    add_entries(1);
...
TEST_F(CollectionTest, DecreaseTest) {
    add_entries(15);
...
TEST_F(CollectionTest, DecreaseToZeroTest) {
    add_entries(15);
...
TEST_F(CollectionTest, CollectionClearedTest) {
    add_entries(15);
...
TEST_F(CollectionTest, BeginToEndEraseTest) {
    add_entries(15);
...
TEST_F(CollectionTest, CapacityUpNoSizeIncreaseTest) {
    add_entries(15);
...
TEST_F(CollectionTest, OutOfRangeTest) {
    ...
    EXPECT_THROW(collection->at(30), std::out_of_range);
}

// TODO: Create 2 unit tests of your own to test something on the collection - do 1 positive & 1 negative
TEST_F(CollectionTest, FailedResizeTest) {
    add_entries(10);
...
}TEST_F(CollectionTest, RandomTestingTest) {
    add_entries(10);

    ASSERT_TRUE((collection->size() / 2) < collection->size());
